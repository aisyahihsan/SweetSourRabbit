...
<title>Search User to Delete | Sweet Sour Rabbit</title>
</head>

<body>
<form id="form1" name="form1" method="get" action="display delete.php">
  <table width="328" border="0" align="center">
    ...
    <tr>
      <td colspan="2" bgcolor="#FFCC66"><blockquote>
        <blockquote>
          <p><img src="themes/images/logo2.png" alt="" width="193" height="37" /></p>
        </blockquote>
      </blockquote></td>
    </tr>
    <tr>
